...
def _render_text(screen: pygame.Surface, text: str) -> None:
    ...
    font = pygame.font.SysFont(FONT_FAMILY, FONT_HEIGHT - 15)
...
if __name__ == '__main__':
    ...
    # })
    run_treemap_file_system('C:\\Users\\DELL\\Desktop\\Uoft Docs\\CSC148S1\\'
                            'csc148\\assignments\\a2\\example-directory')
    # run_treemap_papers()
